...
public class tk2dUIScrollableAreaEditor : Editor
{
    ...
    public void OnSceneGUI()
    {
        ...
        float newContentLength = tk2dUIControlsHelperEditor.DrawLengthHandles("Content Length", scrollableArea.ContentLength, scrollableArea.contentContainer.transform.position, isYAxis ? -up : right, Color.blue, isYAxis ? .2f : -0.2f, isYAxis?0.4f:-.4f, .1f);
